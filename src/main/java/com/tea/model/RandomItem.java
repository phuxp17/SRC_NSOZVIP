...
public class RandomItem {
    ...
    public static void init() {
        ...
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.MANH_SACH_CO);
        BOSS_LANG_TRUYEN_THUYET.add(5, ItemName.KHAI_THU_LENH);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.BAT_BAO);
        BOSS_LANG_TRUYEN_THUYET.add(1, ItemName.RUONG_BACH_NGAN);
        BOSS_LANG_TRUYEN_THUYET.add(0.1, ItemName.HARLEY_DAVIDSON);
        BOSS_LANG_TRUYEN_THUYET.add(2, ItemName.ST);
        BOSS_LANG_TRUYEN_THUYET.add(2, ItemName.PN);
        BOSS_LANG_TRUYEN_THUYET.add(2, ItemName.SM);
        BOSS_LANG_TRUYEN_THUYET.add(20, ItemName.HOA_KY_LAN);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.kim);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.moc);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.thuy);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.hoa);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.tho);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.set);
        BOSS_LANG_TRUYEN_THUYET.add(10, ItemName.anh_sang);
        BOSS_LANG_TRUYEN_THUYET.add(5, ItemName.t1);
        BOSS_LANG_TRUYEN_THUYET.add(4, ItemName.t2);
        BOSS_LANG_TRUYEN_THUYET.add(3, ItemName.t3);
        ...
        LANG_TRUYEN_THUYET.add(2, ItemName.TIEN_HOA_THAO);
        LANG_TRUYEN_THUYET.add(2, ItemName.TUONG_LINH_THAO);
        LANG_TRUYEN_THUYET.add(2, ItemName.THONG_LINH_THAO);
        LANG_TRUYEN_THUYET.add(0.1, ItemName.CHUYEN_TINH_THACH);
        LANG_TRUYEN_THUYET.add(0.1, ItemName.TU_TINH_THACH_TRUNG_CAP);
        LANG_TRUYEN_THUYET.add(0.1, ItemName.TU_TINH_THACH_SO_CAP);
        LANG_TRUYEN_THUYET.add(0.05, ItemName.TU_TINH_THACH_CAO_CAP);
        LANG_TRUYEN_THUYET.add(30, ItemName.BINH_HP_CAO_CAP);
        LANG_TRUYEN_THUYET.add(30, ItemName.BINH_MP_CAO_CAP);
        LANG_TRUYEN_THUYET.add(1, ItemName.GIAY_PHEP_NANG_CAP);
        LANG_TRUYEN_THUYET.add(60, ItemName.YEN);
        LANG_TRUYEN_THUYET.add(2, ItemName.ST);
        LANG_TRUYEN_THUYET.add(2, ItemName.PN);
        LANG_TRUYEN_THUYET.add(2, ItemName.SM);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.LUC_THANH_HOA);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.TU_LINH_LIEN_HOA);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.LINH_LANG_HO_DIEP);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.IK);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.BANH_RANG);
        LANG_TRUYEN_THUYET.add(1.5, ItemName.THUOC_CAI_TIEN);
        LANG_TRUYEN_THUYET.add(10, ItemName.kim);
        LANG_TRUYEN_THUYET.add(10, ItemName.moc);
        LANG_TRUYEN_THUYET.add(10, ItemName.thuy);
        LANG_TRUYEN_THUYET.add(10, ItemName.hoa);
        LANG_TRUYEN_THUYET.add(10, ItemName.tho);
        LANG_TRUYEN_THUYET.add(10, ItemName.set);
        LANG_TRUYEN_THUYET.add(10, ItemName.anh_sang);
        LANG_TRUYEN_THUYET.add(1, 984);
        LANG_TRUYEN_THUYET.add(0.5, 985);
        LANG_TRUYEN_THUYET.add(0.1, 986);
        LANG_TRUYEN_THUYET.add(2, 1290);
        LANG_TRUYEN_THUYET.add(2, 1291);
        LANG_TRUYEN_THUYET.add(2, 1292);
        LANG_TRUYEN_THUYET.add(1, 1295);
        ...
        LANG_CO.add(0.05, ItemName.CHUYEN_TINH_THACH);
        LANG_CO.add(0.04, ItemName.TU_TINH_THACH_SO_CAP);
        LANG_CO.add(0.02, ItemName.TU_TINH_THACH_TRUNG_CAP);
        LANG_CO.add(0.01, ItemName.TU_TINH_THACH_CAO_CAP);
        LANG_CO.add(1.5, ItemName.LUC_THANH_HOA);
        LANG_CO.add(1.5, ItemName.TU_LINH_LIEN_HOA);
        LANG_CO.add(1.5, ItemName.LINH_LANG_HO_DIEP);
        LANG_CO.add(1.5, ItemName.IK);
        LANG_CO.add(1.5, ItemName.BANH_RANG);
        LANG_CO.add(1.5, ItemName.THUOC_CAI_TIEN);
        LANG_CO.add(60, ItemName.YEN);
        LANG_CO.add(2, ItemName.ST);
        LANG_CO.add(2, ItemName.PN);
        LANG_CO.add(2, ItemName.SM);
        LANG_CO.add(2, ItemName.kim);
        LANG_CO.add(2, ItemName.moc);
        LANG_CO.add(2, ItemName.thuy);
        LANG_CO.add(2, ItemName.hoa);
        LANG_CO.add(2, ItemName.tho);
        LANG_CO.add(2, ItemName.set);
        LANG_CO.add(2, ItemName.anh_sang);
        LANG_CO.add(0.5, 984);
        LANG_CO.add(0.2, 985);
        LANG_CO.add(0.05, 986);
        LANG_CO.add(2, 1290);
        LANG_CO.add(2, 1291);
        LANG_CO.add(2, 1292);
        LANG_CO.add(0.5, 1295);
        
        
        
        BOSS_LANG_CO.add(0.1, ItemName.BAT_BAO);
        BOSS_LANG_CO.add(2, ItemName.ST);
        BOSS_LANG_CO.add(2, ItemName.PN);
        BOSS_LANG_CO.add(2, ItemName.SM);
        BOSS_LANG_CO.add(0.5, ItemName.TU_TINH_THACH_TRUNG_CAP);
        BOSS_LANG_CO.add(0.1, ItemName.TU_TINH_THACH_CAO_CAP);
        BOSS_LANG_CO.add(1, ItemName.CHUYEN_TINH_THACH);
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_CUNG);
        BOSS_LANG_CO.add(0.1, ItemName.SACH_VO_CONG_DAO);
        BOSS_LANG_CO.add(0.1, ItemName.SACH_VO_CONG_QUAT);
        BOSS_LANG_CO.add(0.1, ItemName.SACH_VO_CONG_KUNAI);
        BOSS_LANG_CO.add(0.1, ItemName.SACH_VO_CONG_KIEM);
        BOSS_LANG_CO.add(0.1, ItemName.SACH_VO_CONG_TIEU);
        BOSS_LANG_CO.add(1, ItemName.DA_CAP_12);
        BOSS_LANG_CO.add(0.02, ItemName.KHAI_THU_LENH);       
        BOSS_LANG_CO.add(1, ItemName.TIEN_HOA_THAO);
        BOSS_LANG_CO.add(1, ItemName.TUONG_LINH_THAO);
        BOSS_LANG_CO.add(1, ItemName.THONG_LINH_THAO);
        BOSS_LANG_CO.add(20, ItemName.DINH_VI);
        BOSS_LANG_CO.add(20, ItemName.BINH_NITRO);
        BOSS_LANG_CO.add(20, ItemName.DONG_CO_V_POWER);
        BOSS_LANG_CO.add(20, ItemName.BO_DIEU_KHIEN);
        BOSS_LANG_CO.add(10, ItemName.XE_MAY);
        BOSS_LANG_CO.add(5, ItemName.HARLEY_DAVIDSON);
        BOSS_LANG_CO.add(1, ItemName.HUYET_SAC_HUNG_LANG);
        BOSS_LANG_CO.add(20, ItemName.YEN2);
        BOSS_LANG_CO.add(20, ItemName.DAY_CUONG);
        BOSS_LANG_CO.add(20, ItemName.THU_TRANG);
        BOSS_LANG_CO.add(20, ItemName.GIAP_THU);
        BOSS_LANG_CO.add(10, ItemName.XICH_NHAN_NGAN_LANG);
        BOSS_LANG_CO.add(1, ItemName.HUYET_SAC_HUNG_LANG);
        BOSS_LANG_CO.add(10, ItemName.HOA_KY_LAN);
        BOSS_LANG_CO.add(5, ItemName.t1);
        BOSS_LANG_CO.add(4, ItemName.t2);
        BOSS_LANG_CO.add(3, ItemName.t3);
       ...
       // Vùng đất ma quỷ --- đang nhân 10 mỗi item trừ đá 5
        ...
        VDMQ.add(0.05, ItemName.CHUYEN_TINH_THACH);
        VDMQ.add(0.05, ItemName.TU_TINH_THACH_SO_CAP);
        VDMQ.add(0.05, ItemName.TU_TINH_THACH_TRUNG_CAP);
        ...
        VDMQ.add(5, ItemName.PHAN_THAN_LENH);
        VDMQ.add(40, ItemName.DA_CAP_7);
        VDMQ.add(40, ItemName.DA_CAP_8);
        VDMQ.add(40, ItemName.YEN);
        VDMQ.add(1, ItemName.ST);
        VDMQ.add(1, ItemName.PN);
        VDMQ.add(1, ItemName.SM);
...
// Boss vùng đất ma quỷ
        ...
        BOSS_VDMQ.add(5, ItemName.SACH_VO_CONG_KAGE_BUNSHIN);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_KIEM);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_TIEU);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_KUNAI);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_CUNG);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_DAO);
        BOSS_VDMQ.add(0.01, ItemName.SACH_VO_CONG_QUAT);
        ...
        BOSS_VDMQ.add(11, ItemName.ST);
        BOSS_VDMQ.add(11, ItemName.PN);
        BOSS_VDMQ.add(11, ItemName.SM);
        BOSS_VDMQ.add(5, ItemName.t1);
        BOSS_VDMQ.add(4, ItemName.t2);
        BOSS_VDMQ.add(3, ItemName.t3);
        BOSS_VDMQ.add(2, ItemName.t4);
       ...
       RUONG_CHIEN_TRUONG.add(80, -1);
        ...
        LONG_DEN.add(0.01, ItemName.CHUYEN_TINH_THACH);
