...
public class RandomItem {
    ...
    public static void init() {
        ...
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_DAO);
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_QUAT);
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_KUNAI);
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_KIEM);
        BOSS_LANG_CO.add(1, ItemName.SACH_VO_CONG_TIEU);
